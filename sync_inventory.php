...
try {
    echo "Synchronizing local inventory with Shopify (without resetting quantities)...\n\n";
    ...
    echo "Calculating available pack quantities with $currentQuantity blankets:\n";
    ...
    Log::error("Error synchronizing inventory: " . $e->getMessage());
}
